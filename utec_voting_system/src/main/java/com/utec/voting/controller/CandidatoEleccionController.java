...
public class CandidatoEleccionController extends HttpServlet implements Serializable{
	...
	private List<CandidatoEleccion> canElecList = new ArrayList<CandidatoEleccion>();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (us != null) {
				...
				CandidatoEleccion CandidatoEleccionSelected=null;
				...
				response.setContentType("application/json");
					 if(request.getParameter("btnModificar")!=null){
						 if(request.getParameter("celIdEdi") != null && request.getParameter("elcIdEdi") != null  && request.getParameter("canIdEdi") != null) {
							...
							object = new JSONObject(new ClientWebService().clienteWS(URI+"CandidatoEleccion",object, "PUT"));
					 ...
					 if(request.getParameter("btnInsertarCandidatoEleccion")!=null){
						...
						elecList = ClientWebService.stringToArray(new ClientWebService().clienteWS(URI+"elecion", "GET"),Eleccion[].class);
